...
class Order(TimestampMixin, Base):
    ...
    coupon_discount_amount: Mapped[float | None] = mapped_column(Numeric(10, 2))
    checkout_idempotency_key: Mapped[str | None] = mapped_column(String(255), unique=True, index=True)
